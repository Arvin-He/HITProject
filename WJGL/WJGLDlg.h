...
// CWJGLDlg dialog
class CWJGLDlg : public CDialogEx
{
// Construction
public:
	CWJGLDlg(CWnd* pParent = NULL);	// standard constructor
	~CWJGLDlg();
	...
	void UpdateDMC3000Status(int nAxisIndex, int elupID, int eldownID);
private:
